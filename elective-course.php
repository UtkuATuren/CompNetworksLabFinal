        ...
        <div class="row mx-auto">
            ...
            <div class="col-md-8 p-0 mx-auto">
                <div class="container p-0">
                    ...
                    <!--MIDDLE-->
                    <form action="sendElectiveCourse.php" method="POST">
                        <!-- hidden input implying this is a complaint-->
                        <input type="hidden" name="type" value="Elective Course">
                        <!--MIDDLE-->
                        ...
                        <div class="row text-center text-black">
                            <div class="row" style="align-items: center; margin: auto;">
                                <div class="container mt-3 text-start">
                                    ...
                                    <b>Bırakılan dersin kodu:</b> <input type="text" style="width: 100px; margin-left: 1%; margin-right: 0.5%;" draggable="false" name="ex" id="" cols="10" rows="1"><br><br>
                                    <b>Bırakılma nedeni:</b> <input type="text" style="width: 250px; margin-left: 2%; margin-right: 0.5%;" draggable="false" name="why" id="" cols="10" rows="1"><br><br>  
                                    <b>Alınacak dersin kodu:</b> <input type="text" style="width: 80px; margin-left: 3%; margin-right: 0.5%;" draggable="false" name="new" id="" cols="10" rows="1"><br><br>  
                                </div>
                            </div>
                        </div>
                    </div>
